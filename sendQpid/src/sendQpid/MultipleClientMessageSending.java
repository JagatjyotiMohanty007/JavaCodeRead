 ...
 */
				 String  msg ="06-05-14 13:46:26 A:TICGMAIN 19461 SLOT 2 VTI Track 2 Open Track Circuit Detected";
		    ...
		    message.setText(msg);
		         ...
		         session.commit();	          
		         System.out.println("Jagat  message has been tested sucessfully to the queue :Message"+i +msg);
		      }
		} catch (Exception e) {
			try {
				session.close();
