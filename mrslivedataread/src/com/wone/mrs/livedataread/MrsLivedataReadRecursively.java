...
public class MrsLivedataReadRecursively {



	public MrsLivedataReadRecursively() {
	...
	public static void main(String[] args) {
		...
		try {
			...
			MrsLivedataReadRecursively obj = new MrsLivedataReadRecursively();
		...
		try {
			...
			for (File file : files) {
				...
				if (file.isFile()) {
					...
					String hr = newtime;
					month = MrsLivedataReadRecursively.getMonth(month);

					dyndestinationpath = dyndestinationpath + "/" + yr + "/" + month + "/" + day + "/" + hr;
					String mrscbtctwelogsdynamicfolderpathwithfilename = dyndestinationpath + "/" + newfilename
							+ newtimehrdely + "_LOG.txt";
					...
					readMrsSourceFileAndWritetoDestination(mrsSourcePathwithFileName,
							mrscbtctwelogsdynamicfolderpathwithfilename, strDate1, time);
					// readMrsHistoricalSourceFileAndWritetoDestination(mrsSourcePathwithFileName,
					// dyndestinationpath, strDate, time);
				} else if (file.isDirectory()) {
					String srcpath = file.getAbsolutePath().toString();
