...
public class MrsCBTCDataRead {

	public MrsCBTCDataRead() {
		// TODO Auto-generated constructor stub
	}
	final static Logger logger = Logger.getLogger(MrsCBTCDataRead.class);
	...
	public static void main(String[] args) {
		...
		try {
			...
			MrsCBTCDataRead obj = new MrsCBTCDataRead();
			...
			try {
				for (String filename : list) {
					...
					if (deleteflag) {
						...
						month = MrsCBTCDataRead.getMonth(month);
