package com.wone.mrs.livedataread;
...
public class MrsOCMDataRead {

	public MrsOCMDataRead() {
		// TODO Auto-generated constructor stub
	}
	final static Logger logger = Logger.getLogger(MrsOCMDataRead.class);
	...
	public static void main(String[] args) {
		...
		try {
			...
			String deleteocmDirectorypath = ocmlogsDestinationFoderpath;

			boolean deleteflag = false;
			
			MrsOCMDataRead obj = new MrsOCMDataRead();
			String list[] = obj.listofFilesandSubdirectoryInaDirectory(ocmlogsSourcePath);
		
			try {
				for (String filename1 : list) {
					String date1 = obj.getlocalSystemdateforcreatingfolder();
					String time1 = obj.getlocalSystemTimeforcreatingfolder();
					String[] systemdateformatloc1 = date1.split(":");
					String systemdateformat11 = systemdateformatloc1[0];
					String mrscbtctwelogsdynamicfolderpath1 = obj.createDynamicMrsFolders(systemdateformat11, time1,
							ocmlogsDestinationFoderpath);
					...
					String mrscbtctwelogsdynamicfolderpathwithfilename1 = mrscbtctwelogsdynamicfolderpath1 + "/"
							+ newfilename1 + "_" + newtimehrdely1 + ".txt";
					obj.readMrsSourceFileAndWritetoDestination(mrscbtctwelogsSourcefilepathwithname1,
							mrscbtctwelogsdynamicfolderpathwithfilename1, date1, time1);
					...
					if (deleteflag) {
						...
						month = MrsOCMDataRead.getMonth(month);

						deleteocmDirectorypath = deleteocmDirectorypath + "/" + yr + "/" + month + "/" + day;
						System.out.println("deleteocmDirectorypath..." + deleteocmDirectorypath);
						obj.deleteDirectory(deleteocmDirectorypath);
						System.out.println("OCM yesterday data deleted");
					}
