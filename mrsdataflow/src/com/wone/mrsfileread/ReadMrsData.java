...
public class ReadMrsData {

	public ReadMrsData() {
		// TODO Auto-generated constructor stub
	}
	final static Logger logger = Logger.getLogger(ReadMrsData.class);
	...
	public static void main(String[] args) {
		...
		try {
			...
			String list1[] = obj.listofFilesandSubdirectoryInaDirectory(ocmlogsSourcePath);
			try {
				for (String filename : list) {
					...
					if (deleteflag) {
						...
						month = ReadMrsData.getMonth(month);
			...
			try {
				for (String filename1 : list1) {
					...
					String mrscbtctwelogsdynamicfolderpath1 = obj1.createDynamicMrsFolders(systemdateformat11, time1,
					...
					obj1.readMrsSourceFileAndWritetoDestination(mrscbtctwelogsSourcefilepathwithname1,
					...
					if (deleteflag) {
						...
						obj1.deleteDirectory(deleteocmDirectorypath);
